...
ENDPOINT_AUTO_LINK_PAYMENT_AND_MEMBERSHIP_CARD_URL = "/ubiquity/membership_cards?autolink=true"
ENDPOINT_LINK_MEMBERSHIP_PAYMENT = "/ubiquity/membership_card/{}/payment_card/{}"
ENDPOINT_CHECK_MEMBERSHIP_CARDS_BALANCE_URL = "/ubiquity/membership_cards?balances"

ENDPOINT_MEMBERSHIP_PLAN = "/ubiquity/membership_plan/{}"
ENDPOINT_MEMBERSHIP_PLANS = "/ubiquity/membership_plans"

# ENDPOINT_MEMBERSHIP_TRANSACTIONS =
