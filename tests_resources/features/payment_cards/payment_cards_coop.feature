...
Feature: Merchant CooP - Ensure a customer can add their payment card & link it to loyalty membership card
  ...
  Scenario Outline: ADD & LINK Journey_CooP
    ...
    When I perform POST request to add & auto link "CooP" membership card
    Then I perform GET request to verify the "CooP" membership card is added & linked successfully in the wallet
...
#    |          visa        |
    ...
    And I perform the GET request to verify the payment card has been added successfully to the wallet
    When I perform POST request to add "CooP" membership card to my wallet
    ...
    And I perform GET request to verify the "CooP" membership card is linked successfully in the wallet
    ...
    And I perform GET/membership_card/id request to verify the payment card is unlinked from "CooP" membership card
    And I perform GET/payment_card/id request to verify the membership card is unlinked


    @patch_mcard_pcard
    Scenario: PLL Link by PATCH_(pcard_mcard)_CooP
